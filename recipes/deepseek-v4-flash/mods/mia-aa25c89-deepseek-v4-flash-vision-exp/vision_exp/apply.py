...
def apply_vision_exp(
    *,
    ...
    def model_init(self, *, vllm_config, prefix: str = "", **kwargs: Any):
        ...
        orig_model_init(self, vllm_config=vllm_config, prefix=prefix, **kwargs)
    ...
    def moe_init(self, vllm_config, prefix: str = "", **kwargs: Any):
        # Forward **kwargs: the 2026-09-04 nightly added
        # `use_sequence_parallel: bool = False` to DeepseekV4MoE.__init__ and
        # DeepseekV4DecoderLayer passes it through. Without forwarding, the
        # wrapper raises "got an unexpected keyword argument".
        orig_moe_init(self, vllm_config, prefix, **kwargs)
        config = vllm_config.model_config.hf_config
    ...
    def lm_init(self, *, vllm_config, prefix: str = "", **kwargs: Any):
